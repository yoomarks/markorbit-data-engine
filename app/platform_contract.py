...
def platform_contract() -> dict[str, Any]:
    return {
        ...
        "compatibility": {
            ...
            "cn_legacy_case_party_close_history_event_execution_unchanged": True,
            "cn_agent_priority_madrid_case_current_case_party_current_case_scope_relation_scope_carve_out_native_execution": True,
