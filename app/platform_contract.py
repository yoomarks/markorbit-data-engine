...
def platform_contract() -> dict[str, Any]:
    return {
        ...
        "compatibility": {
            ...
            "cn_legacy_case_delta_events_except_case_facts_and_preliminary_unchanged": True,
            "cn_derived_case_baseline_suppression_unchanged": True,
            "cn_agent_priority_madrid_case_current_case_party_current_close_case_scope_relation_scope_carve_out_case_facts_preliminary_event_native_execution": True,
