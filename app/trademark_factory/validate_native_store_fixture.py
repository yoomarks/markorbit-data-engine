...
from app.trademark_factory.native_store import (
...
def main() -> int:
    ...
    assert "source_object_id uuid NOT NULL REFERENCES acquisition.global_trademark_source_object" in rendered
    ...
    with tempfile.TemporaryDirectory(prefix="native-store-fixture-") as temporary:
        ...
        # The writer requires a persisted source-object identity; the UUID is not generated
        # by the observation primitive itself.
