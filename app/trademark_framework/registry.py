...
_GB = CountryPack(
    ...
    sources=(
        ...
        SourceDescriptor(
            ...
            active_now=False,
            pipeline_ready=False,
            adapter_kind=SourceAdapterKind.UNRESOLVED,
            transport=TransportKind.UNRESOLVED,
            data_format=DataFormat.UNKNOWN,
            update_semantics=UpdateSemantics.UNRESOLVED,
            notes="Potential demand-driven detail enrichment; access/transport contract is intentionally unresolved rather than guessed as an API.",
        ),
        SourceDescriptor(
...
_AU = CountryPack(
    ...
    sources=(
        ...
        SourceDescriptor(
            ...
            data_format=DataFormat.UNKNOWN,
            update_semantics=UpdateSemantics.UNRESOLVED,
            notes="Reserved for a later official post-IPGOD source; transport/format/update semantics remain intentionally unresolved until a source is verified.",
        ),
        SourceDescriptor(
