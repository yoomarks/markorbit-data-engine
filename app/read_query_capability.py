    ...
    return {
        ...
        "capabilities": [
            ...
            },
            {
                ...
                "notes": "No canonical CN domestic registration lookup field is frozen yet.",
            },
            {
            ...
            },
            {
                ...
                "notes": (
                    ...
                    "US resolves the exact serial through the native serial-keyed current owner facts, "
                    "then returns the canonical candidate-keyed applicant source_reference. No display-name "
            ...
            },
            {
                ...
                "state": "SUPPORTED_INDEXED_EXACT_NAME",
                "notes": (
                    "Exact normalized attorney-name facts are production-backfilled and accepted "
                    "under US_ATTORNEY_NAME_LOOKUP_READY_V1; runtime revalidates candidates against "
                    "current official correspondent facts and no fuzzy identity resolution is implied."
                ),
            },
            {
            ...
            },
            {
                "id": "relationship_timeline",
                "jurisdictions": ["US"],
                "state": "SUPPORTED_BOUNDED_TWO_STAGE_RECORDED_HISTORY",
                "notes": (
                    "Serial-keyed Assignment and TTAB facts map to direct official historical "
                    "edges without inferring current ownership, proceeding outcome, or substantive rights."
                ),
            },
            {
                "id": "trademark_360",
