...
class NativeAgentCutoverClient:
    ...
    def __init__(
        ...
        *,
        ...
        relation_client = NativeCaseRelationCutoverClient(
            delegate,
        ...
        close_client = NativeCasePartyCloseCutoverClient(
            relation_client,
            execution_client=execution_client,
            package_uuid=package_uuid,
            source_rank=source_rank,
        ...
        registration_client = NativeRegistrationPublicationEventCutoverClient(
            preliminary_client,
            execution_client=execution_client,
            package_uuid=package_uuid,
            source_rank=source_rank,
        ...
        exclusive_client = NativeExclusiveTermEventCutoverClient(
            registration_client,
            execution_client=execution_client,
            package_uuid=package_uuid,
            source_rank=source_rank,
        ...
        agent_code_client = NativeAgentCodeEventCutoverClient(
            mark_name_client,
            execution_client=execution_client,
            package_uuid=package_uuid,
            source_rank=source_rank,
        ...
        goods_scope_client = NativeGoodsScopeEventCutoverClient(
            agent_code_client,
            execution_client=execution_client,
            package_uuid=package_uuid,
            source_rank=source_rank,
