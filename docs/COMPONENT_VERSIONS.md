...
| Contact ingestion | `CONTACT_INGEST_V1.3` | Auto-detected entity/person/contact ingestion across XLSX/CSV/JSON plus TXT, HTML, PDF, DOCX and legacy DOC document sources. |
