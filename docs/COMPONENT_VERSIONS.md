...
| Contact ingestion | `CONTACT_INGEST_V1.2` | Auto-detected external entity/person/contact-channel ingestion with modern QCC batch-export and legacy agent-export compatibility plus trademark entity linking. |
