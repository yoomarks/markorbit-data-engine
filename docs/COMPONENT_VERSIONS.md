...
| Contact ingestion | `CONTACT_INGEST_V1.1` | Auto-detected external entity/person/contact-channel ingestion with legacy agent-export compatibility and trademark entity linking. |
