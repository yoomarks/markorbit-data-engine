...
def test_cn_publish_dag_contract_marks_agent_priority_and_madrid_native() -> None:
    ...
    assert contract["native_node_count"] == 3
    assert contract["compatibility_node_count"] == len(CN_FINAL_PUBLISH_DAG.nodes) - 3
