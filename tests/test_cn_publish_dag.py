...
def test_cn_publish_dag_contract_marks_eight_native_nodes() -> None:
    ...
    assert contract["native_node_count"] == 8
    assert contract["compatibility_node_count"] == len(CN_FINAL_PUBLISH_DAG.nodes) - 8
    ...
    assert nodes["CASE_PARTY_CURRENT_CLOSE"]["native_execution"] is False
