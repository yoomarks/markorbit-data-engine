...
def test_cn_publish_dag_contract_marks_seven_native_nodes() -> None:
    ...
    assert contract["native_node_count"] == 7
    assert contract["compatibility_node_count"] == len(CN_FINAL_PUBLISH_DAG.nodes) - 7
