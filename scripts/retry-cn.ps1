...
if ($LASTEXITCODE -ne 0) {
    throw "M1.5.3 contract preflight failed; real CN package retry was not started."
}

docker compose exec -T api python -m app.cn.validate_fixture
if ($LASTEXITCODE -ne 0) {
    throw "M1.5.3.1 runtime fixture failed; real CN package retry was not started."
}
